...
def parse_prompt():
    ...
    prompt = PromptTemplate(template=question_generation_template, input_variables=["character", "description", "scenario", "mes_example","input", "llama_input", "llama_instruction", "llama_response", "vector_context", "history"])
