...
def get_term_freqs(
    ...
    *,
    ...
    if type_ == "linear":
        ...
        raise ValueError(errors.value_invalid_msg("type_", type_, {"linear", "sqrt", "log"}))
...
def get_inverse_doc_freqs(
    ...
    *,
    ...
    if type_ == "standard":
        ...
        raise ValueError(errors.value_invalid_msg("type_", type_, {"standard", "smooth", "bm25"}))
...
def filter_terms_by_df(
    ...
    *,
    ...
    term_to_id = {term: new_indices[old_index] for term, old_index in term_to_id.items() if mask[old_index]}
