...
from document_parsing.extract import acros, bags, basics, keyterms, kwic, matches, triples
from document_parsing.spacier.extensions import doc_extensions_registry
...
def extract_keyterms(doc: Doc, method: str, **kwargs):
    ...
    if method == "scake":
        ...
        raise ValueError(errors.value_invalid_msg("method", method, {"scake", "sgrank", "textrank", "yake"}))
